...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(AccountManagementAPIException.class)
	public ResponseEntity<ErrorDetails> handleBlogAPIException(AccountManagementAPIException exception, WebRequest webRequest) {
		// don't send whole description of web request.
		// only sending url. Hence, parameter passed into webrequest.getDescription() is FALSE.
